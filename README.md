...
* **Home** 
    ...
    * Bootstrap jumbotron with a heading: Love Food Stop Waste, contains main message and "Find Out More" button, if users wish to explore further, 
...
* Love Your Leftovers   
    * Main banner image is by [Spencer Davies](https://unsplash.com/photos/vJsj-hgOEG0)
